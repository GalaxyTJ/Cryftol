...
{
    vm_shuffle4(vm_shuffle_semicolon, StkId base,  // base for this function
...
typedef struct global_State
{
    ...
    vm_shuffle3(vm_shuffle_semicolon, GCObject* gray,      // list of gray objects
    GCObject* grayagain, // list of objects to be traversed atomically
    GCObject* weak);     // list of weak tables (to be cleared)

    vm_shuffle5(vm_shuffle_semicolon, size_t GCthreshold,                    // when totalbytes > GCthreshold, run GC step
    ...
    vm_value3<TString*> ttname[LUA_T_COUNT],       // names for basic types
    vm_value3<TString*> tmname[TM_N]);            // array with tag-method names
...
struct lua_State
{
    ...
    vm_shuffle6(vm_shuffle_semicolon, StkId top,                                        // first free slot in the stack
    StkId base,                                      // base of current function
    vm_value3<global_State*> global,
    ...
    vm_shuffle3(vm_shuffle_semicolon, Table* gt,           // table of globals
