...
#define luaL_typeerrors(L, narg, tname1, tname2) luaL_typeerrorsL(L, narg, tname1, tname2)
...
LUALIB_API l_noret luaL_typeerrorsL(lua_State* L, int narg, const char* tname1, const char* tname2);
